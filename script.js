...
function coverMarkup(book){return `<div class="book-cover ${book.tone}"><small>${book.coverAuthor}</small><strong>${book.coverTitle}</strong><em>${formatYear(book.year)}</em></div>`}
